...
namespace UnityEngine.Perception.GroundTruth
{
    ...
    /// </summary>
    [Serializable]
    public sealed class Custom3dKeypointLabeler : CameraLabeler
    {
        ...
        /// are assigned.
        /// </summary>
        public Custom3dKeypointLabeler() { }
        ...
        public Custom3dKeypointLabeler(IdLabelConfig config, KeypointTemplate template)
        {
        ...
        private CustomRenderTextureReader<Color32> m_DepthCheckReader;
        ...
        void SetupDepthCheckBuffers(int size)
        {
            ...
            m_DepthCheckReader = new CustomRenderTextureReader<Color32>(m_ResultsBuffer);
        }
            ...
            float occlusionDistance)
        {
            ...
            keypoints[idx].vx = position.x;
            keypoints[idx].vy = position.y;
            keypoints[idx].vz = position.z;
